...
$txt['install_step_welcome'] = 'Dobro došli';
$txt['install_step_writable'] = 'Provera dozvola za pisanje';
$txt['install_step_forum'] = 'Podešavanje Foruma';
$txt['install_step_databaseset'] = 'Podešavanja baze podataka';
$txt['install_step_databasechange'] = 'Populacija Baze podataka';
$txt['install_step_admin'] = 'Admin Nalog';
$txt['install_step_delete'] = 'Završetak instalacije';

$txt['smf_installer'] = 'SMF Instaler';
$txt['installer_language'] = 'Jezik';
$txt['installer_language_set'] = 'Set';
$txt['congratulations'] = 'Čestitamo, proces intalacije je završen!';
...
$txt['delete_installer'] = 'Kliknite ovde da izbrišete install.php fajl.';
...
$txt['good_luck'] = 'Srećno!<br>Simple Machines';

$txt['install_welcome'] = 'Dobro došli';
...
$txt['user_refresh_install'] = 'Forum Osvežen';
...
$txt['default_topic_subject'] = 'Dobro došli na SMF!';
$txt['default_topic_message'] = 'Dobro došli na Simple Machines Forum!<br><br>Nadamo se da uživate u korišćenju vašeg foruma.&nbsp; Ukoliko imate nekih problema, budite slobodni da [url=http://www.simplemachines.org/community/index.php?board=114.0]zatražite pomoć[/url].<br><br>Hvala!<br>Simple Machines';
$txt['default_board_name'] = 'Generalna Diskusija';
$txt['default_board_description'] = 'Budite slobodni da diskutujete o bilo čemu u ovom forumu.';
$txt['default_category_name'] = 'Generalna Kategorija';
$txt['default_time_format'] = '%b %d, %Y, %I:%M %p';
$txt['default_news'] = 'SMF - Tek instaliran!';
...
$txt['error_message_click'] = 'Klilknite ovde';
$txt['error_message_try_again'] = 'da ponovite ovaj korak.';
$txt['error_message_bad_try_again'] = 'da pokušate instalaciju u svakom slučaju, ali imajte na umu da je ovo <em>jako</em> nepreporučljivo.';

$txt['install_settings'] = 'Podešavanja foruma';
$txt['install_settings_info'] = 'Ova stranica zahteva definisanje nekoliko ključnih podešavanja za forum. SMF je automatski detektovao ključna podešavanja za vas.';
$txt['install_settings_name'] = 'Ime foruma';
$txt['install_settings_name_info'] = 'Ovo je ime vašeg foruma, npr. &quot;Test Forum&quot;.';
$txt['install_settings_name_default'] = 'Moja Zajednica';
$txt['install_settings_url'] = 'URL Foruma';
$txt['install_settings_url_info'] = 'Ovo je URL adresa foruma <strong>bez kosih crta \'/\'!</strong>.<br>U većini slučajeva možete ostaviti podrazumevanu vrednost u ovom polju, u većini slučajeva je tačna.';
$txt['install_settings_reg_mode'] = 'Način registracije';
$txt['install_settings_reg_modes'] = 'Načini registracije';
$txt['install_settings_reg_immediate'] = 'Instant registracija';
$txt['install_settings_reg_email'] = 'Akctivacija E-mailom';
$txt['install_settings_reg_admin'] = 'Odobrenje administratora';
$txt['install_settings_reg_disabled'] = 'Isključena registracija';
$txt['install_settings_reg_mode_info'] = 'Ovo polje vam omogućava da podesite način registracije, kako biste sprečili neželjene registracije.';
$txt['install_settings_compress'] = 'Kompresovani izlaz';
$txt['install_settings_compress_title'] = 'Kopresovanje izlaza kako bi se sačuvao bandwidth.';
...
$txt['install_settings_dbsession'] = 'Sesije baze podataka';
$txt['install_settings_dbsession_title'] = 'Koristite bazu podataka za sesije umesto fajlova.';
$txt['install_settings_dbsession_info1'] = 'Ova opcija je skoro uvek odgovarajuća za upotrebu jer čini sesije tačnije.';
$txt['install_settings_dbsession_info2'] = 'This feature is generally a good idea, but it may not work properly on this server.';
$txt['install_settings_utf8'] = 'UTF-8 Karakter set';
$txt['install_settings_utf8_title'] = 'Koristite UTF-8 kao podrazumevani karakter set';
$txt['install_settings_utf8_info'] = 'Ova opcija podrazumeva da baza podataka i fajlovi koriste internacionalni karakter set, UTF-8. Ovo može biti naročito dobro ako koristite više jezika koji koriste različite karakter setove.';
$txt['install_settings_stats'] = 'Omogući skupljanje statistike';
$txt['install_settings_stats_title'] = 'Omogućite SMF-u da prikuplja osnovne statistike na mesečnom nivou.';
...
$txt['install_settings_proceed'] = 'Nastavite';

$txt['db_settings'] = 'Podešavanja baze podataka servera';
...
$txt['db_settings_username'] = 'Korisničko ime';
...
$txt['db_settings_password'] = 'Šifra';
...
$txt['db_settings_database'] = 'Ime baze podataka';
$txt['db_settings_database_info'] = 'Unesite ime baze podataka u kojoj će SMF čuvati neophodne podatke.';
$txt['db_settings_database_info_note'] = 'Ukoliko ova baza podataka ne postoji, SMF će pokušati da je kreira.';
$txt['db_settings_port'] = 'Port baze podataka';
$txt['db_settings_port_info'] = 'Ostavite prazno za korišćenje podrazumevanog';
$txt['db_settings_prefix'] = 'Prefix tabela';
...
$txt['db_populate'] = 'Baza podataka populisana';
...
$txt['db_populate_info2'] = 'Kliknite &quot;Nastavak&quot; za kreiranje administratorskog naloga.';
$txt['db_populate_inserts'] = 'Insertovano %1$d kolona.';
$txt['db_populate_tables'] = 'Kreirano %1$d tabela.';
$txt['db_populate_insert_dups'] = 'Ignorisano %1$d duplih insertova.';
$txt['db_populate_table_dups'] = 'Ignorisano %1$d duplih tabela.';

$txt['user_settings'] = 'Create your account';
$txt['user_settings_info'] = 'Instaler će kreirati novi administratorski nalog za vas.';
$txt['user_settings_username'] = 'Vaše korisničko ime';
$txt['user_settings_username_info'] = 'Izaberite ime za prijavljivanje.<br>Ovo može biti promenjeno kasnije.';
...
$txt['user_settings_admin_email'] = 'Imejl adresa administratora';
$txt['user_settings_admin_email_info'] = 'Unestite vašu imejl adresu. Ovo mora biti validna imejl adresa!';
$txt['user_settings_server_email'] = 'Imejl adresa webmaster-a';
$txt['user_settings_server_email_info'] = 'Unesite <strong>imejl adresu koju SMF koristi za slanje mejlova</strong>. Ovo mora biti validna imejl adresa!';
$txt['user_settings_database'] = 'Šifra baze podataka';
...
$txt['user_settings_skip_sure'] = 'Da li ste sigurni da želite da preskočite kreiranje korisničkog naloga?';
$txt['user_settings_proceed'] = 'Završi';

$txt['ftp_checking_writable'] = 'Checking files are writable';
$txt['ftp_setup'] = 'FTP Informacije';
...
$txt['ftp_setup_why'] = 'Za šta služi ovaj korak?';
...
$txt['error_ftp_no_connect'] = 'Nije moguće konektovati se na FTP sa datim detaljima.';
...
$txt['error_user_settings_again_match'] = 'Naveli ste dve različite šifre!';
$txt['error_user_settings_no_password'] = 'Šifra mora biti najmanje 4 karaktera dugačka.';
...
$txt['error_valid_admin_email_needed'] = 'Niste naveli validnu imejl adresu za administratorski nalog.';
$txt['error_valid_server_email_needed'] = 'Niste naveli validnu imejl adresu za webmaster-a.';
...
$txt['error_username_left_empty'] = 'Polje za korisničko ime je prazno.';
$txt['error_db_prefix_reserved'] = 'Prefiks koji ste uneli je rezervisan prefiks. Molimo koristite drugi prefiks.';
$txt['error_utf8_support'] = 'The database you are trying to use is not using UTF8 charset';

$txt['ftp_login'] = 'Vaše FTP informacije';
...
$txt['ftp_path_help_close'] = 'Zatvori';
$txt['ftp_connect'] = 'Konektuj se';

$txt['force_ssl'] = 'Uključite SSL';
$txt['force_ssl_label'] = 'Forsirajte SSL kroz forum';
...
$txt['upgrade_step_login'] = 'Prijavljivanje';
...
$txt['upgrade_upgrade_utility'] = 'SMF Alat za Nadogradnju';
...
$txt['upgrade_note'] = 'Napomena!';
$txt['upgrade_step'] = 'Korak';
$txt['upgrade_steps'] = 'Koraka';
$txt['upgrade_progress'] = 'Napredak';
$txt['upgrade_overall_progress'] = 'Celokupan Napredak';
$txt['upgrade_step_progress'] = 'Napredak koraka';
$txt['upgrade_time_elapsed'] = 'Vremana utrošeno';
$txt['upgrade_time_mins'] = 'minuta';
$txt['upgrade_time_secs'] = 'sekundi';
$txt['upgrade_username'] = 'Korisničko ime:';
$txt['upgrade_wrong_username'] = 'Username Incorrect';
$txt['upgrade_password'] = 'Lozinka:';
...
$txt['upgrade_incomplete'] = 'Nije kompletno';
$txt['upgrade_not_quite_done'] = 'Još uvek nije završeno!';
...
$txt['upgrade_delete_now'] = 'Uklonite upgrade.php fajl kao i propratne fajlove';
...
$txt['upgrade_ftp_login'] = 'Vaše FTP informacije';
...
$txt['upgrade_ftp_warning'] = 'Upozorenje';
...
$txt['upgrade_cachedir'] = 'Direktorijum za keširanje:';
...
$txt['backup_database'] = 'Rezervna kopija baze podataka.';
